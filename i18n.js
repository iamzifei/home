...
const STRINGS = {
  'zh-Hant': {
    ...
    'p.city': '雪梨',
    'c.kick': '線下課 · 雪梨',
    'c.title': '不知道做什麼，做了又沒人買',
    'c.sub': '一天，把「該做什麼」和「憑什麼有人買」這兩件事定下來。',
    'c.facts': '2026-9-19 週六 · 雪梨 City · 10 席 · 中文講',
    'c.more': '課程詳情',
    'vt.kick': '每週四 · 雪梨 · 免費',
    'vt.title': 'Vibe Thursday · 每週四上午的 AI 聚會',
    'vt.sub': '一群在做東西的人圍一張桌子喝咖啡，聊各自在用 AI 幹什麼、卡在哪。手上有東西想給大家看，隨時可以；只想聽，也完全沒問題。',
    'vt.facts': '每週四 10:30 開門 · Chatswood The Avenue · 免費，店裡點杯喝的就行',
    'vt.more': '報名 · vibethursday.com',
    'p.issue': '第 %s 號',
    'p.issue0': '創刊',
    'p.date': '%s 年 %s 月 %s 日',
    'p.apps': '四個 macOS App',
  ...
  'en': {
    ...
    'p.city': 'Sydney',
    'c.kick': 'In person · Sydney',
    'c.title': 'Not sure what to build — and what you built, nobody buys',
    'c.sub': 'One day to settle two things: what to make, and why anyone would pay for it.',
    'c.facts': 'Sat 19 Sep 2026 · Sydney City · 10 seats · taught in Mandarin',
    'c.more': 'About the class',
    'vt.kick': 'Every Thursday · Sydney · free',
    'vt.title': "Vibe Thursday · Sydney's weekly AI table",
    'vt.sub': 'A table of people who build things, over coffee, talking about what they are doing with AI and where they are stuck. Got something to show? Go ahead. Only want to listen? Also fine.',
    'vt.facts': 'Thursdays · doors 10:30am · The Avenue, Chatswood · free, just order a drink',
    'vt.more': 'Sign up · vibethursday.com',
    'p.issue': 'No. %s',
