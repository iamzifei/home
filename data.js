  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        stars: 1,
        cta: {
          label: { zh: "装上它 · 六种装法", "zh-Hant": "裝上它 · 六種裝法", en: "Install it · six ways in" },
          href: "https://github.com/iamzifei/aikey#怎么装完全没接触过-ai-也能跟着做",
          cmd: "npx skills add iamzifei/aikey",
          note: { zh: "装完在对话里输入 /key，说一句你卡在哪，它替你挑技能。手机上用豆包的，仓库里有一段 30 秒的安装演示。", "zh-Hant": "裝完在對話裡輸入 /key，說一句你卡在哪，它替你挑技能。手機上用豆包的，儲存庫裡有一段 30 秒的安裝演示。",
                  en: "Once it is in, type /key in the chat and say where you are stuck; it picks the skill for you. If your AI lives on a phone (豆包), the repository has a 30-second install clip." },
        },
        shot: "assets/key-hero.webp",
        /* A real session, time-lapsed: .webm/.mp4 siblings of `shot`,
           and the .webp is frame 0 of them — see tools/term-motion.py. */
        motion: true,
        heroCap: { zh: "一次真实的 /key 会话，等待时间已抽掉。原始时长 2 分 32 秒。", "zh-Hant": "一次真實的 /key 會話，等待時間已抽掉。原始時長 2 分 32 秒。",
                   en: "One real /key session, with the waiting taken out. It took 2 min 32 s." },
        shots: [
          { src: "assets/key-route.webp",
            cap: { zh: "它挑了哪个技能，以及为什么不是另外两个——归因判完，才知道该去改选题还是改开头。", "zh-Hant": "它挑了哪個技能，以及為什麼不是另外兩個——歸因判完，才知道該去改選題還是改開頭。",
                   en: "It names the skill it picked and why it is not the other two — you only know whether the topic or the opening is the problem after the attribution is done." } },
